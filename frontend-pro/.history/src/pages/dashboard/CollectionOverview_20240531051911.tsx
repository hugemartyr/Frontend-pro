...
//run a loop this array to assgin seller id to index of the object , username to 1n, Wallet address to 2nd element of each element , price to 3rd element , gameComapnay
