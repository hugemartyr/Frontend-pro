    ...
    async function ShowAllSkins() {
        ...
        try {
            ...
            for (const id of skinIds) {
                const sellersOfSkin :any[]= await skinMarket.methods.getSellers(id).call();
                // Assuming you have a way to categorize skins, you can do so here
                // For example, if the category is part of the skin or seller data:
                ...
                skinData[category].push({
                    ...
                    seller: {
                        id: sellersOfSkin.id,
                        username: sellersOfSkin.username,
                        gameCompany: sellersOfSkin.gameCompany,
                        price: sellersOfSkin.price,
                        walletAddress: sellersOfSkin.walletAddress
                    }
                });
            }
            setSkins(skinData);
